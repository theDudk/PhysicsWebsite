...
let lessons = [
    ...
    [[
        ...
        new NumQuestion("Assignment 2C", "Determine the distance and displacement for each of the following questions. An object moves 8.45 cm up, 3.46 cm down, 0.0561 m up, and 0.0632 m down", false, ["cm", "23.8"], ["cm [up]", "4.28"]),
        new NumQuestion("Assignment 2D", "Using convention, determine the distance and displacement for each of the following questions. An object moves 3.56 km [E], 7855 m [W], 2.543 km [W], and 5.00 x 10^5 cm left", false, ["km", "19.0"], ["km [+]", "-11.8"]),
        new NumQuestion("Assignment 2E", "Using convention, Determine the distance and displacement for each of the following questions. An object moves 7.5 cm left, 62 mm right, 0.012 m [W], and 2.3 cm [E].", false, ["cm", "17"], ["cm [-]", "0.20"]),
        new NumQuestion("Assignment 2F", "Using convention, Determine the distance and displacement for each of the following questions. An object moves 16 km [E], 17,000 m left, 4.5x10^5 cm right, and 25 km [W].", false, ["km", "63"], ["km [+]", "-22"]),
    ...
    [[
        ...
        new NumQuestion("Example 7", "If a ball is thrown up in the air at 15.0 m/s, how long will it take to reach its maximum height? What is the total time that the ball is in the air?", false, ["s", "1.53"], ["s", "3.06"]),
        ...
        new NumQuestion("Assignment 1", "A car starts from rest and accelerates to 100 km/h in exactly 1 min. What was the acceleration?", false, ["m/s^2", "0.463"]),
        ...
        new NumQuestion("Assignment 10", "An precisely 0.5 kg rock is launched upward with an initial speed of 80.0 m/s. How long will it take for the rock to reach its maximum height? How long is the rock in the air? What will the rock’s velocity be after 11.0 s?", false, ["s", "8.15"],["s", "16.3"],["m/s [down]", "27.9"]),
    ...
    [[
        ...
        new NumQuestion("example 6", "How fast will an object be traveling after falling for 7.0 s?", false, ["m/s [down]", "69"]),
        ...
        new NumQuestion("Practice 4", "A ball is dropped from a height of 3.5 m into the hand of a person waiting below. The ball comes to rest in the person’s hand over a distance of 0.25 m. What was the acceleration of the ball when it landed in the person’s hand?", false, ["* 10^2 m/s^2 [up]", "1.4"]),
    ...
    [[
        ...
        new NumQuestion("Assignment 3", "A stone is thrown vertically upward from a 117.82 m high cliff with an initial speed of 19.62 m/s. How long will it take for the stone to hit the water below? (Answer in 3SD)", false, ["s", "7.29"]),
    ...
    [[
        ...
        new NumQuestion("Trigonometry Review 8", "The hypotenuse of an isosceles right triangle is 20 cm long. What is the length of the other two sides? What are the other two angles?", false, ["cm", "14"], ["cm", "14"], ["°", "45"], ["°", "45"]),
    ...
    [[
        ...
        new NumQuestionIMG("Assignment Question 6", "Two people can paddle a canoe at 4.75 km/h in still water. A river has a 2.65 km/h [E] current. A. If the canoeists wish to paddle north across the river, what angle should the keel of the canoe make with the south shoreline? B. If the river is 0.50 km wide [N], how much time is required to make the journey (in minutes)? ", false, "images/L12/2.png", ["° [N of W]", "56"], ["min", "7.6"]),
        new NumQuestion("Assignment Question 7", "The pilot of a ferry boat, with a cruising speed of 12 km/h, wishes to sail north from Georgetown, Malaysia to Medan, Indonesia across the Strait of Malacca. If the strait has a 3.0 km/h current flowing west, what course should the pilot set to compensate for the current? If the distance from Georgetown to Medan is 100 km, how long will the sailing take? ", false, ["° [E of N]", "14"], ["h", "8.6"]),
        new NumQuestion("Assignment Question 8", "A pilot heads her plane with a velocity of 255 km/h north. If there is a strong 112 km/h wind blowing east, what is the velocity of the plane in reference to the ground? What angle is it travelling relative to the ground? ", false, ["km/h", "279"], ["° [E of N]", "23.7"]),
        new NumQuestion("Assignment Question 9", "A pilot wants to fly west. If the plane has an airspeed of 95.0 m/s and there is a 25.0 m/s wind blowing north: A. In what direction must she head the plane? B. What will be her speed relative to the ground? C. How far will the plane go in 2.25 h? ", false, ["° [S of W]", "15.3"], ["m/s", "91.7"], ["km [W]", "742"]),
        new NumQuestion("Assignment Question 10", "A 70 m wide river flows at 0.80 m/s [E]. A girl swims across it at 1.4 m/s [N] relative to the water. A) What is the least time she requires to cross the river? B) How far downstream will she be when she lands on the opposite shore? c) At what angle to the shore would she have to aim, in order to arrive at a point directly opposite the starting point? D) How long would the trip in part (C) take? ", false, ["s", "50"], ["m [E]", "40"], ["° W of N]", "35"], ["s", "61"]),
    ...
    [[
        ...
        new NumQuestion("Example 3", "A rock is thrown with a speed of 30.0 m/s at 30.0° below the horizontal from a 150 m sheer cliff. How far away from the base of the cliff did the rock land?", false, ["m", "109"]),
    ...
    [[
        ...
        new NumQuestion("Example 7", "A 15 kg object is pushed from rest for 5.0 s by a 60 N east force and then it is allowed to continue moving. The object eventually comes to rest. If the frictional force is 20 N, how far from its starting point does the object come to rest?", false, ["* 10^2 m", "1.0"]),
        ...
        new NumQuestion("Assignment 12", "An 8.0 g bullet travelling at 400 m/s [N] passes through a heavy block of wood in 4.0 x 10^-4 s and emerges with a velocity of 100 m/s [N]. (a) With what average force did the wood oppose the motion of the bullet? (b) How thick is the block of wood?", false, ["10^3 N [N]", "-6.0"], ["10^-1 m", "1.0"]),
    ...
    [[
        ...
        new NumQuestion("Example 3", "A 10 kg box is dragged over a horizontal surface by a force of 40 N. If the box moves with a constant speed of 0.50 m/s, what is the coefficient of kinetic friction for the surface? ", false, ["", "0.41"]),
        ...
        new NumQuestion("Practice 3", "A rope attached to a 50 kg box is being pulled at an angle of 25° across a horizontal floor where the coefficient of static friction is 0.20. What is the acceleration of the box if a 200 N force is applied? ", false, ["m/s^2", "2.0"]),
        new NumQuestion("Assignment Question 2", "It takes a 50 N horizontal force to pull a 20 kg object along the ground at constant velocity. What is the coefficient of friction?", false, ["", "0.25"]),
    ...
    [[
        ...
        new NumQuestion("Assignment 3", "A jet accelerates vertically up at 8.5 m/s^2. What force does the exhaust gas exert on the 4400 kg jet?", false, ["* 10^4 N", "8.1"]),
    ...
    [[
        ...
        new NumQuestion("Assignment 2", "An airplane flies in a horizontal circle of radius 1000 m. If its centripetal acceleration is 25 m/s^2, how long does it take to complete one circuit?", false, ["s", "40"]),
        ...
        new NumQuestion("Assignment 6", "Europa is a moon of the planet Jupiter. Europa requires 3.551 days to orbit Jupiter at a distance of 6.71 x 10^8 m. If the mass of Europa is 4.88 x 10^22 kg, what is the centripetal force exerted on Europa by Jupiter?", false, ["* 10^22 N", "1.37"]),
    ...
    [[
        ...
        new NumQuestionIMG("Assignment 2", "A woman standing on the surface of the Earth, 6.38 x 10^6 m from its centre, has a mass of 50.0 kg. If the mass of the Earth is 5.98 x 10^24 kg, what is the force of gravity on the woman?", false, "images/L21/1.png", ["N", "490"]),
        ...
        new NumQuestionIMG("Assignment 4", "If the force of gravity on a mass is 600 N on Earth, what will it be on Mars?", false, "images/L21/1.png", ["N", "221"]),
    ...
    [[
        ...
        new NumQuestionIMG("Example 2", "What is the gravitational field strength at a distance of 1.914 x 10^7 m above the surface of the Earth? If a person weighs 400 N on the surface, what would he weigh at this distance?", false, "images/L21/1.png", ["N/kg", "0.613"], ["N", "25.0"]),
        new NumQuestion("Practice 1", "What is the gravitational field strength on the surface of Earth? What is the gravitational field strength 100 km above the surface of Earth? ", false, ["m/s^2", "9.81"], ["m/s^2", "9.51"]),
        ...
        new NumQuestionIMG("Assignment 1", "Calculate the acceleration due to gravity on Jupiter. (3SD)", false, "images/L21/1.png", ["m/s^2", "24.6"]),
    ...
    [[
        ...
        new NumQuestion("Assignment 3", "Calculate the height above the Earth's surface for a satellite with a speed of 7.60 * 10^3 m/s?", false, ["* 10^5 m", "5.24"]),
    ...
    [[
        ...
        new NumQuestion("Assignment 4", "Two springs are hooked together and one end is attached to a ceiling. Spring A has a spring constant of 25 N/m, and spring B has a spring constant of 60 N/m. A mass weighing 40.0 N is attached to the free end of the spring system to pull it downward from the ceiling. What is the total displacement of the mass? ", false, ["m [up]", "-2.3"]),
    ...
    [[
        ...
        new NumQuestion("Example 2", "Find the work done in pulling a luggage carrier by a 45.0 N force at an angle of exactly 50° for a distance of 75.0 m.", false, ["* 10^3 Nm", "2.17"]),
        ...
        new NumQuestionIMG("Example 12", "A car driven at 100 km/h is overcoming a frictional force of 3200 N. How much power is being produced? What is the horsepower?", false, "images/L26/5.png", ["kW", "88.9"], ["h.p.", "119"]),
        ...
        new NumQuestionIMG("Work 1a", "Given the following force-displacement graph, determine the work done.", false, "images/L26/1.png", ["J", "56"]),
        new NumQuestionIMG("Work 1b", "Given the following force-displacement graph, determine the work done.", false, "images/L26/2.png", ["J", "-26"]),
    ...
    [[
        ...
        new NumQuestionIMG("Assignment 6", "A roller coaster is shown in the drawing. Assuming no friction, calculate the speed at points B, C, D, assuming it has a speed of 1.80 m/s at point A. ", false, "images/L27/4.png", ["m/s", "24.3"], ["m/s", "9.90"], ["m/s", "18.8"]),
    ...
    [[
        ...
        new NumQuestion("Assignment 3", "Determine the magnitude of the restoring force of a pendulum that is pulled to an angle of 12.0° left of the vertical. The mass of the bob is 300.0 g.", false, ["N", "0.612"]),

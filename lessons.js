...
let lessons = [
    ...
    [[
        ...
        new NumQuestion("Example 8", "A force of 90 N is applied to a sled (mass 40 kg) at an angle of 30° to the horizontal. If the frictional force is 27.94 N, what is the resulting acceleration of the sled?", false, ["m/s^2", "1.2"]),
    ...
    [[
        ...
        new NumQuestion("Assignment Question 4", "A box, mass = 2.0 kg, is pulled across a level desk by a horizontal force of 4.0 N. If the coefficient of kinetic friction is 0.12, what is the acceleration of the box?", false, ["m/s^2", "0.83"]),
        ...
        new NumQuestion("Assignment Question 8", "A boy pulls a 50 kg crate across a level floor with a force of 200 N. If the force acts at an angle of 30o up from the horizontal, and the coefficient of kinetic friction is 0.30, determine A. the normal force exerted on the crate by the floor B. the frictional force exerted on the crate by the floor C. the acceleration of the crate. ", false, ["*10^2 N", "3.9"], ["*10^2 N", "1.2"], ["m/s^2", "1.1"]),
    ...
    [[
        ...
        new NumQuestion("Assignment 3", "You are rotating a bucket of water in a vertical circle. Assuming that the radius of the rotation of the water is 0.95 m, what is the minimum velocity of the bucket at the top of its swing if the water is not to spill? ", false, ["m/s", "3.05"]),
    ...
    [[
        ...
        new NumQuestionIMG("Assignment 1", "A satellite is located 250 km above the surface of the Earth. How long would it take for the satellite to complete one orbit of the Earth?", "images/L21/1.png", false, ["* 10^3 s", "5.37"]),
        ...
        new NumQuestionIMG("Assignment 5", "The Earth is 1.49 x 10^11 m away from the Sun and it requires 365.25 days to complete one orbit. Calculate the speed of the Earth in its orbit around the Sun. Calculate the mass of the Sun.", false, "images/L21/1.png", ["* 10^30 kg", "1.97"]),
        ...
        new NumQuestionIMG("Assignment 7", "If a planet orbiting the Sun had a period of 7.82 x 10^9 s, how far is the planet from the Sun?", false, "images/L21/1.png", ["* 10^12 m", "5.89"]),
    ...
    [[
        ...
        new NumQuestion("Example 2", "A snowmobile driver with a mass of 100 kg traveling at 15.0 m/s slams into a snow drift. If the driver sinks 0.50 m into the snow drift before stopping, what is the retarding force applied by the snow drift?", false, ["* 10^5 N", "2.5"]),
    ...
    [[
        ...
        new NumQuestionIMG("Assignment 8", "For the following diagram, what is the angle of reflection from surface Y? What is the angle between the wave ray and surface Y?", false, "images/L30/4.png", ["°", "40"], ["°", "50"]),
        new NumQuestion("Assignment 9", "For the following diagram, what is the angle of reflection from surface Z?", false, ["°", "8"]),
    ...
    [[
        ...
        new NumQuestion("Assignment 2", "A factory whistle emits a sound with a wavelength of 38.0 cm. If the speed of sound is 340 m/s, what frequency will be heard by you if you are driving at 20.0 m/s (a) away from the whistle and (b) toward the whistle?", false, ["Hz", "842"], ["Hz", "948"]),
